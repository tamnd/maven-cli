...
heroTitle: "maven, from the command line"
heroLead: "Search Maven Central artifacts One pure-Go binary, no API key, output that pipes into the rest of your tools."
